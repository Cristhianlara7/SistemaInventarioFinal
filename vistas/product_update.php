	...
	<form action="./php/producto_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="column">
		    <div class="control">
		        ...
		        <select class="input" name="producto_iva" >
		            <option value="0" <?php echo ($datos['producto_iva'] == 0) ? 'selected' : ''; ?>>0% - Exento</option>
		            <option value="5" <?php echo ($datos['producto_iva'] == 5) ? 'selected' : ''; ?>>5% - Tarifa reducida</option>
		            <option value="19" <?php echo ($datos['producto_iva'] == 19) ? 'selected' : ''; ?>>19% - Tarifa general</option>
		        </select>
		    </div>
		</div>
