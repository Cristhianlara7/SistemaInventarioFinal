    ...
    <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown">
                    <a href="index.php?vista=sale_new" class="navbar-item">Nueva venta</a>
                    <a href="index.php?vista=sale_list" class="navbar-item">Lista de ventas</a>
                    <a href="index.php?vista=dashboard_reports" class="navbar-item">Dashboard de Reportes</a>
                </div>
            </div>
